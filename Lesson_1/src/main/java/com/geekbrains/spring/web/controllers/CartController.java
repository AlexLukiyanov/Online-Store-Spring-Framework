...
public class CartController {
    ...
    public void removeProductToCart(@PathVariable Long id, @RequestBody String cartName)  {
        service.removeProductByIdToCart(id, cartName);
    }

    @PostMapping("/decrease/{id}")
    public void decreaseProductToCart(@PathVariable Long id, @RequestBody String cartName) {
        service.decreaseProductByIdToCart(id, cartName);
    }
